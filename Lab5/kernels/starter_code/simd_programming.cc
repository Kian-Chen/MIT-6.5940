        ...
        for (int col = 0; col < n; col++) {
            ...
            for (int q = 0; q < num_block; q++) {
                ...
                */
                ...
                const uint8x16_t w_low4bit = vandq_u8(w0, mask_low4bit);
                const uint8x16_t w_upper4bit = vandq_u8(vshrq_n_u8(w0, 4), mask_low4bit)
                const int8x16_t w_lowbit_s8 = vreinterpretq_s8_u8(w_low4bit);
                const int8x16_t w_upper4bit_s8 = vreinterpretq_s8_u8(vshrq_n_u8(w0, 4));
                ...
                const int8x16_t w_lower4bit_s8_central = vsubq_s8(w_lowbit_s8, offsets);
                const int8x16_t w_upper4bit_s8_central = vsubq_s8(w_upper4bit_s8, offsets);
                ...
                int32x4_t int_sum0;
                int_sum0 = vdotq_s32(int_sum0, a0, w_lower4bit_s8_central);
                int_sum0 = vdotq_s32(int_sum0, a1, w_upper4bit_s8_central);
